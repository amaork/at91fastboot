...
LINUX_KERNEL_PRESET_LPJ	:= lpj=
LINUX_KERNEL_ENABLE_CONSOLE := printk.time=1
LINUX_KERNEL_DISABLE_CONSOLE := quiet

ifdef CONFIG_DISABLE_CONSOLE
LINUX_KERNEL_ARG_STRING := $(filter-out $(LINUX_KERNEL_DISABLE_CONSOLE),$(LINUX_KERNEL_ARG_STRING))
LINUX_KERNEL_ARG_STRING := $(LINUX_KERNEL_ARG_STRING) $(LINUX_KERNEL_DISABLE_CONSOLE)
else
LINUX_KERNEL_ARG_STRING := $(filter-out $(LINUX_KERNEL_ENABLE_CONSOLE),$(LINUX_KERNEL_ARG_STRING))
LINUX_KERNEL_ARG_STRING := $(filter-out $(LINUX_KERNEL_DISABLE_CONSOLE),$(LINUX_KERNEL_ARG_STRING))
LINUX_KERNEL_ARG_STRING := $(LINUX_KERNEL_ARG_STRING) $(LINUX_KERNEL_ENABLE_CONSOLE)
endif

ifdef CONFIG_PRESET_LPJ
LINUX_KERNEL_ARG_STRING := $(filter-out $(LINUX_KERNEL_PRESET_LPJ)%,$(LINUX_KERNEL_ARG_STRING))
LINUX_KERNEL_ARG_STRING := $(LINUX_KERNEL_ARG_STRING) $(LINUX_KERNEL_PRESET_LPJ)$(strip $(subst ",,$(CONFIG_LPJ_VALUE)))
endif
